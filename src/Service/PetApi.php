...
class PetApi
{
     ...
     *
     * @param \Appkr\PetStore\Model\Pet $body Pet object that needs to be added to the store (required)
    ...
    {
        list($response) = $this->deletePetWithHttpInfo($petId, $apiKey);
        return $response;
    }
    ...
    public function deletePetWithHttpInfo($petId, $apiKey = null)
    {
        ...
        // header params
        if ($apiKey !== null) {
            $headerParams['api_key'] = $this->apiClient->getSerializer()->toHeaderValue($apiKey);
        }
        // path params
        if ($petId !== null) {
            $resourcePath = str_replace(
                "{" . "petId" . "}",
                $this->apiClient->getSerializer()->toPathValue($petId),
                $resourcePath
            );
        }
     ...
     * @throws \Appkr\PetStore\ApiException on non-2xx response
     * @return \Appkr\PetStore\Model\Pet[]
     */
     ...
     * @param string[] $status Status values that need to be considered for filter (required)
     * @throws \Appkr\PetStore\ApiException on non-2xx response
     * @return array of \Appkr\PetStore\Model\Pet[], HTTP status code, HTTP response headers (array of strings)
     */
    public function findPetsByStatusWithHttpInfo($status)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Appkr\PetStore\Model\Pet[]',
                '/pet/findByStatus'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Appkr\PetStore\Model\Pet[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Appkr\PetStore\Model\Pet[]', $e->getResponseHeaders());
    ...
    {
        list($response) = $this->updatePetWithFormWithHttpInfo($petId, $name, $status);
        return $response;
    }
     ...
     * @throws \Appkr\PetStore\ApiException on non-2xx response
     * @return \Appkr\PetStore\Model\ApiResponse
     */
    public function uploadFile($petId, $additionalMetadata = null, $file = null)
    {
        list($response) = $this->uploadFileWithHttpInfo($petId, $additionalMetadata, $file);
        return $response;
    }
     ...
     * @param \SplFileObject $file file to upload (optional)
     * @throws \Appkr\PetStore\ApiException on non-2xx response
     * @return array of \Appkr\PetStore\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadFileWithHttpInfo($petId, $additionalMetadata = null, $file = null)
    {
        // verify the required parameter 'petId' is set
        if ($petId === null) {
        ...
        if ($additionalMetadata !== null) {
            $formParams['additionalMetadata'] = $this->apiClient->getSerializer()->toFormValue($additionalMetadata);
        }
        // form params
        if ($file !== null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Appkr\PetStore\Model\ApiResponse',
                '/pet/{petId}/uploadImage'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Appkr\PetStore\Model\ApiResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Appkr\PetStore\Model\ApiResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
