...
class Pet implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'category' => '\Appkr\PetStore\Model\Category',
        'name' => 'string',
        'photoUrls' => 'string[]',
        'tags' => '\Appkr\PetStore\Model\Tag[]',
        'status' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['photoUrls'] = isset($data['photoUrls']) ? $data['photoUrls'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['photoUrls'] === null) {
            $invalid_properties[] = "'photoUrls' can't be null";
        }
    ...
    /**
     * Gets category
     * @return \Appkr\PetStore\Model\Category
     */
    ...
    /**
     * Sets category
     * @param \Appkr\PetStore\Model\Category $category
     * @return $this
     */
    ...
    /**
     * Gets tags
     * @return \Appkr\PetStore\Model\Tag[]
     */
    ...
    /**
     * Sets tags
     * @param \Appkr\PetStore\Model\Tag[] $tags
     * @return $this
     */
