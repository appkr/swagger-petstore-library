# appkr/swagger-petstore-library
...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/appkr/swagger-petstore-library.git"
    }
  ],
  "require": {
    "appkr/swagger-petstore-library": "*@dev"
  }
}
```
...
```php
    require_once('/path/to/appkr/swagger-petstore-library/autoload.php');
```
